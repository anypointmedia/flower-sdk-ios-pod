...
/// Usage:
///
///     let device = RefOtt_Device.current
///
...
public enum RefOtt_Device {
  ...
  indirect case simulator(RefOtt_Device)
  ...
  public static var current: RefOtt_Device {
    return RefOtt_Device.mapToDevice(identifier: RefOtt_Device.identifier)
  }
  ...
  ///
  /// - parameter identifier: The device identifier, e.g. "iPhone7,1". Can be obtained from `RefOtt_Device.identifier`.
  ///
  /// - returns: An initialized `Device`.
  public static func mapToDevice(identifier: String) -> RefOtt_Device { // swiftlint:disable:this cyclomatic_complexity function_body_length
    #if os(iOS)
      switch identifier {
  ...
  public static func realDevice(from device: RefOtt_Device) -> RefOtt_Device {
  ...
  public var screenRatio: (width: Double, height: Double) {
  ...
  #if os(iOS)
    /// All iPods
    public static var allPods: [RefOtt_Device] {
      return [.iPodTouch5, .iPodTouch6, .iPodTouch7]
    }

    /// All iPhones
    public static var allPhones: [RefOtt_Device] {
    ...
    /// All iPads
    public static var allPads: [RefOtt_Device] {
    ...
    public static var allXSeriesDevices: [RefOtt_Device] {
    ...
    public static var allPlusSizedDevices: [RefOtt_Device] {
    ...
    /// All Pro Devices
    public static var allProDevices: [RefOtt_Device] {
    ...
    /// All mini Devices
    public static var allMiniDevices: [RefOtt_Device] {
      return [.iPadMini, .iPadMini2, .iPadMini3, .iPadMini4, .iPadMini5, .iPadMini6]
    }

    /// All simulator iPods
    public static var allSimulatorPods: [RefOtt_Device] {
      return allPods.map(RefOtt_Device.simulator)
    }

    /// All simulator iPhones
    public static var allSimulatorPhones: [RefOtt_Device] {
      return allPhones.map(RefOtt_Device.simulator)
    }

    /// All simulator iPads
    public static var allSimulatorPads: [RefOtt_Device] {
      return allPads.map(RefOtt_Device.simulator)
    }

    /// All simulator iPad mini
    public static var allSimulatorMiniDevices: [RefOtt_Device] {
      return allMiniDevices.map(RefOtt_Device.simulator)
    }

    /// All simulator X series Devices
    @available(*, deprecated, renamed: "allSimulatorDevicesWithSensorHousing")
    public static var allSimulatorXSeriesDevices: [RefOtt_Device] {
      return allDevicesWithSensorHousing.map(RefOtt_Device.simulator)
    }

    /// All simulator Plus and Max-Sized Devices
    public static var allSimulatorPlusSizedDevices: [RefOtt_Device] {
      return allPlusSizedDevices.map(RefOtt_Device.simulator)
    }

    /// All simulator Pro Devices
    public static var allSimulatorProDevices: [RefOtt_Device] {
      return allProDevices.map(RefOtt_Device.simulator)
    }

    /// Returns whether the device is an iPod (real or simulator)
    public var isPod: Bool {
      return isOneOf(RefOtt_Device.allPods) || isOneOf(RefOtt_Device.allSimulatorPods)
    }

    /// Returns whether the device is an iPhone (real or simulator)
    public var isPhone: Bool {
      return (isOneOf(RefOtt_Device.allPhones)
              || isOneOf(RefOtt_Device.allSimulatorPhones)
              || (UIDevice.current.userInterfaceIdiom == .phone && isCurrent)) && !isPod
    }

    /// Returns whether the device is an iPad (real or simulator)
    public var isPad: Bool {
      return isOneOf(RefOtt_Device.allPads)
              || isOneOf(RefOtt_Device.allSimulatorPads)
              || (UIDevice.current.userInterfaceIdiom == .pad && isCurrent)
    }

    /// If this device is a simulator return the underlying device,
    /// otherwise return `self`.
    public var realDevice: RefOtt_Device {
      return RefOtt_Device.realDevice(from: self)
    }
    ...
    public static var allTouchIDCapableDevices: [RefOtt_Device] {
    ...
    public static var allFaceIDCapableDevices: [RefOtt_Device] {
    ...
    public static var allBiometricAuthenticationCapableDevices: [RefOtt_Device] {
    ...
    public var isTouchIDCapable: Bool {
      return isOneOf(RefOtt_Device.allTouchIDCapableDevices) || isOneOf(RefOtt_Device.allTouchIDCapableDevices.map(RefOtt_Device.simulator))
    }

    /// Returns whether or not the device has Face ID
    public var isFaceIDCapable: Bool {
      return isOneOf(RefOtt_Device.allFaceIDCapableDevices) || isOneOf(RefOtt_Device.allFaceIDCapableDevices.map(RefOtt_Device.simulator))
    }
    ...
    public static var allDevicesWithSensorHousing: [RefOtt_Device] {
      return [.iPhoneX, .iPhoneXS, .iPhoneXSMax, .iPhoneXR, .iPhone11, .iPhone11Pro, .iPhone11ProMax, .iPhone12, .iPhone12Mini, .iPhone12Pro, .iPhone12ProMax, .iPhone13, .iPhone13Mini, .iPhone13Pro, .iPhone13ProMax, .iPhone14, .iPhone14Plus, .iPhone14Pro, .iPhone14ProMax, .iPhone15, .iPhone15Plus, .iPhone15Pro, .iPhone15ProMax, .iPhone16, .iPhone16Plus, .iPhone16Pro, .iPhone16ProMax]
    }

    /// All simulator devices that feature a sensor housing in the screen
    public static var allSimulatorDevicesWithSensorHousing: [RefOtt_Device] {
      return allDevicesWithSensorHousing.map(RefOtt_Device.simulator)
    }

    /// Returns whether or not the device has a sensor housing
    public var hasSensorHousing: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithSensorHousing) || isOneOf(RefOtt_Device.allDevicesWithSensorHousing.map(RefOtt_Device.simulator))
    }

    /// All devices that feature a screen with rounded corners.
    public static var allDevicesWithRoundedDisplayCorners: [RefOtt_Device] {
    ...
    public var hasRoundedDisplayCorners: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithRoundedDisplayCorners) || isOneOf(RefOtt_Device.allDevicesWithRoundedDisplayCorners.map(RefOtt_Device.simulator))
    }

    /// All devices that have the Dynamic Island.
    public static var allDevicesWithDynamicIsland: [RefOtt_Device] {
    ...
    public var hasDynamicIsland: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithDynamicIsland) || isOneOf(RefOtt_Device.allDevicesWithDynamicIsland.map(RefOtt_Device.simulator))
    }

    /// All devices that have 3D Touch support.
    public static var allDevicesWith3dTouchSupport: [RefOtt_Device] {
    ...
    public var has3dTouchSupport: Bool {
      return isOneOf(RefOtt_Device.allDevicesWith3dTouchSupport) || isOneOf(RefOtt_Device.allDevicesWith3dTouchSupport.map(RefOtt_Device.simulator))
    }

    /// All devices that support wireless charging.
    public static var allDevicesWithWirelessChargingSupport: [RefOtt_Device] {
    ...
    public var supportsWirelessCharging: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithWirelessChargingSupport) || isOneOf(RefOtt_Device.allDevicesWithWirelessChargingSupport.map(RefOtt_Device.simulator))
    }

    /// All devices that support 5G.
    public static var allDevicesWith5gSupport: [RefOtt_Device] {
    ...
    public var has5gSupport: Bool {
      return isOneOf(RefOtt_Device.allDevicesWith5gSupport) || isOneOf(RefOtt_Device.allDevicesWith5gSupport.map(RefOtt_Device.simulator))
    }

    /// All devices that have a LiDAR sensor.
    public static var allDevicesWithALidarSensor: [RefOtt_Device] {
    ...
    public var hasLidarSensor: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithALidarSensor) || isOneOf(RefOtt_Device.allDevicesWithALidarSensor.map(RefOtt_Device.simulator))
    }

    /// All devices that have a USB-C connectivity.
    public static var allDevicesWithUSBCConnectivity: [RefOtt_Device] {
    ...
    public var hasUSBCConnectivity: Bool {
      return isOneOf(RefOtt_Device.allDevicesWithUSBCConnectivity) || isOneOf(RefOtt_Device.allDevicesWithUSBCConnectivity.map(RefOtt_Device.simulator))
    }
  #elseif os(tvOS)
    /// All TVs
    public static var allTVs: [RefOtt_Device] {
       return [.appleTVHD, .appleTV4K, .appleTV4K2, .appleTV4K3]
    }

    /// All simulator TVs
    public static var allSimulatorTVs: [RefOtt_Device] {
      return allTVs.map(RefOtt_Device.simulator)
    }
  #elseif os(watchOS)
    /// All Watches
    public static var allWatches: [RefOtt_Device] {
    ...
    public static var allSimulatorWatches: [RefOtt_Device] {
      return allWatches.map(RefOtt_Device.simulator)
    }

    /// All watches that have Force Touch support.
    public static var allWatchesWithForceTouchSupport: [RefOtt_Device] {
    ...
    public var hasForceTouchSupport: Bool {
      return isOneOf(RefOtt_Device.allWatchesWithForceTouchSupport) || isOneOf(RefOtt_Device.allWatchesWithForceTouchSupport.map(RefOtt_Device.simulator))
    }
  #endif
  ...
  public static var allRealDevices: [RefOtt_Device] {
    #if os(iOS)
  ...
  /// All simulators
  public static var allSimulators: [RefOtt_Device] {
    return allRealDevices.map(RefOtt_Device.simulator)
  }

  /// Returns whether the device is any of the simulator
  /// Useful when there is a need to check and skip running a portion of code (location request or others)
  public var isSimulator: Bool {
    return isOneOf(RefOtt_Device.allSimulators)
  }
  ...
  /**
   ...
   ```
   let device = RefOtt_Device.current
   if device.isOneOf(RefOtt_Device.allPods) {
     callMethodOnIPods()
   } else if device.isOneOf(RefOtt_Device.allPhones) {
     callMethodOnIPhones()
   } else if device.isOneOf(RefOtt_Device.allPads) {
     callMethodOnIPads()
   }
   ```
   ...
   */
  public func isOneOf(_ devices: [RefOtt_Device]) -> Bool {
  ...
  private var isCurrent: Bool {
    return self == RefOtt_Device.current
  }
...
extension RefOtt_Device: CustomStringConvertible {
  ...
  /// Example:
  /// RefOtt_Device.iPhoneXR.description:     iPhone Xʀ
  /// RefOtt_Device.iPhoneXR.safeDescription: iPhone XR
...
// MARK: Equatable
extension RefOtt_Device: Equatable {
  ...
  public static func == (lhs: RefOtt_Device, rhs: RefOtt_Device) -> Bool {
...
// MARK: RefOtt_Device.Batterystate: Comparable
#if os(iOS) || os(watchOS)
@available(iOS 8.0, watchOS 4.0, *)
extension RefOtt_Device.BatteryState: Comparable {
  ...
  public static func == (lhs: RefOtt_Device.BatteryState, rhs: RefOtt_Device.BatteryState) -> Bool {
    return lhs.description == rhs.description
  }
...
extension RefOtt_Device {
  ...
  public static var volumeTotalCapacity: Int? {
    return (try? RefOtt_Device.rootURL.resourceValues(forKeys: [.volumeTotalCapacityKey]))?.volumeTotalCapacity
  }
...
extension RefOtt_Device {
  ...
  public static var allApplePencilCapableDevices: [RefOtt_Device] {
...
extension RefOtt_Device {
  ...
  public static var allDevicesWithCamera: [RefOtt_Device] {
  ...
  public static var allDevicesWithNormalCamera: [RefOtt_Device] {
    return RefOtt_Device.allDevicesWithWideCamera
  }

  /// All devices that feature a wide camera
  public static var allDevicesWithWideCamera: [RefOtt_Device] {
    return [.iPodTouch5, .iPodTouch6, .iPodTouch7, .iPhone4, .iPhone4s, .iPhone5, .iPhone5c, .iPhone5s, .iPhone6, .iPhone6Plus, .iPhone6s, .iPhone6sPlus, .iPhone7, .iPhone7Plus, .iPhoneSE, .iPhone8, .iPhone8Plus, .iPhoneX, .iPhoneXS, .iPhoneXSMax, .iPhoneXR, .iPhone11, .iPhone11Pro, .iPhone11ProMax, .iPhoneSE2, .iPhone12, .iPhone12Mini, .iPhone12Pro, .iPhone12ProMax, .iPhone13, .iPhone13Mini, .iPhone13Pro, .iPhone13ProMax, .iPhoneSE3, .iPhone14, .iPhone14Plus, .iPhone14Pro, .iPhone14ProMax, .iPhone15, .iPhone15Plus, .iPhone15Pro, .iPhone15ProMax, .iPhone16, .iPhone16Plus, .iPhone16Pro, .iPhone16ProMax, .iPad2, .iPad3, .iPad4, .iPadAir, .iPadAir2, .iPad5, .iPad6, .iPadAir3, .iPad7, .iPad8, .iPad9, .iPad10, .iPadAir4, .iPadAir5, .iPadAir11M2, .iPadAir13M2, .iPadMini, .iPadMini2, .iPadMini3, .iPadMini4, .iPadMini5, .iPadMini6, .iPadPro9Inch, .iPadPro12Inch, .iPadPro12Inch2, .iPadPro10Inch, .iPadPro11Inch, .iPadPro12Inch3, .iPadPro11Inch2, .iPadPro12Inch4, .iPadPro11Inch3, .iPadPro12Inch5, .iPadPro11Inch4, .iPadPro12Inch6, .iPadPro11M4, .iPadPro13M4]
  }

  /// All devices that feature a telephoto camera
  public static var allDevicesWithTelephotoCamera: [RefOtt_Device] {
  ...
  public static var allDevicesWithUltraWideCamera: [RefOtt_Device] {
...
extension RefOtt_Device.CPU: CustomStringConvertible {
